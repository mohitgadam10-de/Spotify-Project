# 🎧 Spotify 2023 Streaming Titans & Audio Analytics — Tableau Project 🔍

This project delivers a deep-dive analysis into Spotify’s 2023 music ecosystem, focusing on global streaming leaders, genre popularity shifts, and the technical audio characteristics that drive viral success. Using comprehensive datasets, these dashboards help music industry analysts and creators identify dominant market trends and the "sonic profile" of a hit song.
...
The project utilizes a rich collection of Spotify metadata including:
* **Track Metadata:** Most popular tracks and artists.
* **Audio Features:** Loudness decibel levels and popularity scores.
* **Engagement Data:** Cumulative popularity share by genre and quarter.

---

## 🎯 Project Objectives

* Identify the definitive leaderboard of top-performing tracks, albums, and artists in 2023.
* Analyze market engagement across major genres like Pop, Canadian Hip Hop, and R&B.
* Track quarterly momentum shifts and seasonal listening behavior.
* Investigate the correlation between decibel compression (loudness) and listener popularity.
* Provide actionable insights for music production and marketing strategies.
...
* 🌊 **Seasonal Volatility:** **Melodic Rap** exhibits high seasonal fluctuation, with its popularity share surging by nearly **56%** between Q2 (**5.09%**) and Q3 (**7.98%**).
...
* 📉 **The Ambient Gap:** Lower-volume tracks (**Silence/Ambient**) suffer from both low production volume and the lowest listener traction.
* 🧠 **Strategic Takeaway:** To maximize popularity potential, the data suggests production should lean toward the **"Loud/Compressed"** spectrum to match mainstream listener appeal.

---

## 🛠️ Tech Stack

* **Tableau Public** — Visual analytics and Data Modelling (Performed data cleaning and calculated fields directly in Tableau).
* **Kaggle** — Source for global music dataset.
* **CSV / Excel** — Source data.

## 🚀 Future Enhancements

* Integrate streaming platform comparisons (Spotify vs. Apple Music).
* Incorporate sentiment analysis of lyrics to correlate mood with popularity.
* Expand the loudness study to include "Liveness" and "Danceability" metrics.

---

## 👤 Author

**Sai Mohit Gadam** 📍 Vancouver, BC  
